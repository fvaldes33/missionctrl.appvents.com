      ...
      <section className="bg-primary-50 py-12">
        <div className="prose pt-16 mx-auto lg:prose-lg">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Mission Ctrl for
                DigitalOcean, the software program provided by the Company.
              </p>
            </li>
            <li>
              <p>
                ...
                in this Agreement) refers to Appvents LLC, 10617 Providence
                Arbours Dr, Charlotte, NC 28270.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              <p>By email: franco@appvents.com</p>
            </li>
            <li>
              <p>
